...
<ul class="nav nav-list">  
    ...
    <sec:ifAnyGranted roles="ROLE_ADMINISTRADOR, ROLE_PODERES, ROLE_PODERES_RESOLVEDOR, ROLE_PODERES_NOTARIO, ROLE_PODERES_SOLICITANTE, ROLE_PODERES_GESTOR, ROLE_GESTOR_EXTERNO, ROLE_SOLICITANTE_EXTERNO">
    ...
    <sec:ifAnyGranted roles="ROLE_ADMINISTRADOR, ROLE_PODERES, ROLE_PODERES_SOLICITANTE, ROLE_SOLICITANTE_EXTERNO">
        <li class="active open">
            <a href="#" class="dropdown-toggle">
                <i class="icon-book"></i>
