                            ...
                            <g:form method="post">
                                <g:each in="${otorgamientosRojosList.sort{it.id}}" status="i" var="otorgamientoInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <g:if test="${otorgamientoInstance.voBoDocumentoFisico == true || otorgamientoInstance.tareas}">
                                            <td>
                    ...
                    <div class="message-container">
                        ...
                        <table class="box-style" width="100%" border="2">
                            ...
                            <tbody>
                                ...
                                <g:each in="${poderCriticoInstanceList.sort{it.id}}" status="i" var="otorgamientoInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        <td></td>
                                        <td>
                                ...
                                <g:each in="${poderSemicriticoInstanceList.sort{it.id}}" status="i" var="otorgamientoInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        <td></td>
                                        <td>
