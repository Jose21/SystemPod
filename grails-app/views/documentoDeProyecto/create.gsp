...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <br/>
            <g:link class="btn btn-small btn-info btn-block" controller="otorgamientoDePoder" action="show" id="${session.idOtorgamiento}">
                El proyecto se asociará al Otorgamiento de Poder: ${session.idOtorgamiento}-O
            </g:link>
            </br>
            </br>
            ...
            <g:hasErrors bean="${documentoDeProyectoInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${documentoDeProyectoInstance}" var="error">
