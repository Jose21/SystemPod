...
<html>
  <head>
    ...
    <title><g:layoutTitle default='Consola de Seguridad de la Aplicación'/></title>
  ...
  <div>
    <div>
      ...
      <ul class="jd_menu jd_menu_slate">
        <li><g:link controller="dashboard" action='index'>Inicio</g:link></li>
        ...
        <li>
          <a class="accessible"><g:message code="spring.security.ui.menu.roles"/></a>
          <ul>
      ...
      <div id='s2ui_header_body'>
        ...
        <div id='s2ui_header_title'>
          Consola de Seguridad de la Aplicación
        </div>
        ...
        <span id='s2ui_login_link_container'>
          ...
          <nobr>
            <div id='loginLinkContainer'>
              <sec:ifLoggedIn>
                Autenticado como <sec:username/> (<g:link controller='logout'>Salir</g:link>)
              </sec:ifLoggedIn>
              <sec:ifNotLoggedIn>
