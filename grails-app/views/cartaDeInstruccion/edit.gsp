...
<html>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <g:hasErrors bean="${cartaDeInstruccionInstance}">
        <ul class="errors" role="alert">
          <g:eachError bean="${cartaDeInstruccionInstance}" var="error">
          ...
          <g:form class="form-horizontal" method="post" >
            ...
            <g:hiddenField name="version" value="${cartaDeInstruccionInstance?.version}" />
