...
<div class="control-group fieldcontain ${hasErrors(bean: personaInstance, field: 'institucion', 'error')} ">
  <label for="institucion" class="control-label">
    <g:message code="persona.institucion.label" default="Institución" />

  </label>
  <div class="controls">
    <g:textField name="institucion" value="${personaInstance?.institucion}"/>
  </div>
</div>
