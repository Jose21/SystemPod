...
<html>
	...
	<body>
		<a href="#list-motivoDeOtorgamiento" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-motivoDeOtorgamiento" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${motivoDeOtorgamientoInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
