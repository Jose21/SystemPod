...
<html>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <g:hasErrors bean="${motivoDeOtorgamientoInstance}">
        <ul class="errors" role="alert">
          <g:eachError bean="${motivoDeOtorgamientoInstance}" var="error">
          ...
          <g:form class="form-horizontal" method="post" >
            ...
            <g:hiddenField name="version" value="${motivoDeOtorgamientoInstance?.version}" />
