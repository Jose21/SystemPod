...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <g:hasErrors bean="${motivoDeRevocacionInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${motivoDeRevocacionInstance}" var="error">
            ...
            <g:form class="form-horizontal" method="post" >
                ...
                <g:hiddenField name="version" value="${motivoDeRevocacionInstance?.version}" />
