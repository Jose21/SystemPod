                ...
                <div class="offset1 span10">
                    <div class="timeline-container timeline-style2">
                        <div class="timeline-label">
                            <span class="label label-purple arrowed-in-right label-large">
                                        ...
                                        <div class="widget-box transparent">
                                            <div class="itemdiv dialogdiv">                                            
                                                <div class="body">
                                                    <div class="time">
                                                        <i class="icon-user"></i>
                                                        <span class="green">Editado por: ${convenioInstance?.usuario}</span><br/>
                                                        <i class="icon-key"></i>
                                                        <span class="green">IN: ${convenioInstance?.usuario?.username}</span>                                                    
                                                    </div>
                                                    <div class="widget-body">
                                                        <div class="widget-main no-padding">                                                        
                                                        <span class="blue bolder">${fieldValue(bean: convenioInstance, field: "accion")}</span>
                                                        </div>
                                                    </div>
                                                    <div class="widget-body">
